...
(function(global, factory) {
  ...
  const Button = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("button", {
      ...dataSet,
      id,
      className: c__default.default(style$8.button, style$8[`${type}`], style$8[`${size}`], {
  ...
  const IconButton = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("div", {
      className: c__default.default(style$7.wrapper, {
  ...
  const Link = ({
    ...
    className: c__default.default(style$6.link, {
  ...
  const InfoCard = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("article", {
      ...
      children: [/* @__PURE__ */ jsxRuntime.jsx("div", {
        ...
        className: c__default.default(style$5.count, {
          skeleton: isLoading
        }),
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsxRuntime.jsx("div", {
            ...
            className: c__default.default(style$5.detailsLineValue, {
              skeleton: isLoading
            }),
