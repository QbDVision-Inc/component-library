...
(function(global, factory) {
  ...
  const Button = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("button", {
      ...dataSet,
      id,
      className: c__default.default(style$9.button, style$9[`${type}`], style$9[`${size}`], {
  ...
  const IconButton = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("div", {
      className: c__default.default(style$8.wrapper, {
  ...
  const Link = ({
    ...
    className: c__default.default(style$7.link, {
  ...
  const InfoCard = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("article", {
      ...
      children: [/* @__PURE__ */ jsxRuntime.jsx("div", {
        ...
        className: c__default.default(style$6.count, {
          skeleton: isLoading
        }),
        ...
        return /* @__PURE__ */ jsxRuntime.jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsxRuntime.jsx("div", {
            ...
            className: c__default.default(style$6.detailsLineValue, {
              skeleton: isLoading
            }),
  ...
  const DropdownButton = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("div", {
      className: c__default.default([style$4.dropdown, {
  ...
  const Breadcrumb = ({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {
      children: links.map((item2, index) => /* @__PURE__ */ jsxRuntime.jsxs("div", {
        className: c__default.default(style$2.wrapper, {
      ...
      children: [backButtonLink2 && /* @__PURE__ */ jsxRuntime.jsx("a", {
        ...
        children: [/* @__PURE__ */ jsxRuntime.jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsxRuntime.jsx("h3", {
            className: c__default.default(style$1.displayName, {
