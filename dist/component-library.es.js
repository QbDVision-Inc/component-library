...
import { faCaretDown, faFileLines, faArrowUpRightFromSquare, faEllipsisVertical } from "@fortawesome/free-solid-svg-icons";
...
const Button = ({
  ...
  return /* @__PURE__ */ jsxs("button", {
    ...dataSet,
    id,
    className: c(style$5.button, style$5[`${type}`], style$5[`${size}`], {
